...
* If you get an error like cannot find `-ltinfo`, you need to install the ncurses headers. The right command for Ubuntu is `sudo apt install libncurses-dev`. The right command for Fedora is `dnf install ncurses-devel`.
...
*   Additional resources
    ...
    *   [Learn You a Haskell for Great Good!](https://learnyouahaskell.github.io/chapters.html) – a nice free introduction to Haskell. This is a newer fork of an older book, which is actively maintained.
